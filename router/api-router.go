...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.POST("/copilot/oauth/start", controller.StartCopilotOAuth)
			channelRoute.POST("/copilot/oauth/poll", controller.PollCopilotOAuth)
			channelRoute.POST("/:id/copilot/oauth/start", controller.StartCopilotOAuthForChannel)
			channelRoute.POST("/:id/copilot/oauth/poll", controller.PollCopilotOAuthForChannel)
