...
var defaultModelRatio = map[string]float64{
	...
	// GitHub Copilot (per-request billing, ratios approximate)
	"copilot/gpt-4o":                    1.25,
	"copilot/gpt-4o-mini":               0.075,
	"copilot/gpt-4.1":                   1.0,
	"copilot/gpt-4.1-mini":              0.2,
	"copilot/gpt-4.1-nano":              0.05,
	"copilot/o1":                        7.5,
	"copilot/o1-mini":                   1.5,
	"copilot/o1-preview":                7.5,
	"copilot/o3":                        5.0,
	"copilot/o3-mini":                   0.55,
	"copilot/o4-mini":                   0.55,
	"copilot/claude-3.5-sonnet":         1.5,
	"copilot/claude-3.7-sonnet":         1.5,
	"copilot/claude-3.7-sonnet-thought": 1.5,
	"copilot/claude-sonnet-4":           1.5,
	"copilot/gemini-2.0-flash-001":      0.05,
	"copilot/gemini-2.5-pro":            0.625,
